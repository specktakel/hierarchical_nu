...
& = T\frac{Q}{4 \pi d_L(z_k)^2} \frac{(\alpha -1)}{E_\mathrm{min}} \int_{E _\mathrm{min}}^{\infty} \mathrm{d}E \ A_\mathrm{eff}(E, \varpi_k) \Bigg( \frac{(1+z_k)E}{E_\mathrm{min}} \Bigg)^{-\alpha}.
\end{split}
\end{equation}
