...
def test_logparabola_E0():
    ...
    fit = StanFit(sources, IC86, events, lifetime, n_grid_points=20)
    fit.precomputation()
...
def test_logparabola_beta_E0():
    ...
    fit = StanFit(
        sources, IC86, events, lifetime, n_grid_points=20, nshards=2
    )
    fit.precomputation()
    fit.generate_stan_code()
    fit.compile_stan_code()
